                        ...
                        <div class="column">
                            <div class="match-details">
                                <div class="match-date">
                                    <?php if(isAdmin()):?>
                                        <button type="button" id="seewho" onload="location.href='./modify.php';">MODIFY</button>
                                    <?php endif?> <br>
                                    <?=$match['date']?>
                                </div>
                                <div class="match-score">
                                    <?php if(decided($match)):?>
                                        <span class="match-score-number match-score-number--leading"><?=$match['home']['score']?></span>
                                        <span class="match-score-divider">:</span>
                                        <span class="match-score-number"><?=$match['away']['score']?></span>
                                    <?php else:?>
                    ...
                    <?php elseif(away($match)):?>
                        ...
                        <div class="column">
                            <div class="match-details">
                                ...
                                <div class="match-score">
                                    <?php if(decided($match)):?>
                                        <span class="match-score-number match-score-number--leading"><?=$match['away']['score']?></span>
                                        <span class="match-score-divider">:</span>
                                        <span class="match-score-number"><?=$match['home']['score']?></span>
                                    <?php else:?>
                                        <span class="match-score-number match-score-number--leading">◻</span>
                                        <span class="match-score-divider">:</span>
                                        <span class="match-score-number">◻</span>
                                    ...
                                    <div class="comment-main-level">
                                        ...
                                        <div class="comment-box">
                                            <div class="comment-head">
                                                <h6 class="comment-name by-author"><a href="http://creaticode.com/blog"><?=$comment['author']?></a></h6>
                                            ...
                                            <div>
                                            <?php if(isAdmin()):?>
                                                <button type="button" id="seewho" onload="location.href='./delete.php?time=<?= $comment['id']?>&teamID=<?=$teamID?>';">DELETE COMMENT</button>
                                            <?php endif?> <br>
                                            </div>
                                        </div>
                                    </div>
